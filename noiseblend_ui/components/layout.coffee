...
Layout = (props) ->
    ...
    <div
        ...
        { props.children }
        {if props.loading
            <div className='loading-lines flex-column-center'>
                <LoadingLines className='la-1-5x mb-2' />
                <div className='font-weight-bold text-center'>Loading</div>
            </div>
        }
        <Navbar />
        <BackButton
