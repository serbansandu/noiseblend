...
{ Types, Creators } = createActions(
    ...
    setPremiumDialogVisible: ['premiumDialogVisible']
...
setPremiumDialogVisible = (state, { premiumDialogVisible }) -> {
    state...
    premiumDialogVisible
}
...
ACTION_HANDLERS =
    ...
    "#{ Types.SET_PREMIUM_DIALOG_VISIBLE }": setPremiumDialogVisible
